...
from .views import HealthView, LoginTokenView, MeView, RegisterView
...
urlpatterns = [
    ...
    path('auth/login/', LoginTokenView.as_view(), name='token_login'),
    path('auth/login', LoginTokenView.as_view(), name='token_login_noslash'),
    path('auth/token/', LoginTokenView.as_view(), name='token_obtain_pair'),
    path('auth/token', LoginTokenView.as_view(), name='token_obtain_pair_noslash'),

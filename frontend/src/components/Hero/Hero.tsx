        ...
        <div className="flex  justify-between items-center">
          <div className="max-w-190">
           ...
           lg:text-1xl pb-12 text-left"
            ...
            hover:bg-primary-dark-80 font-medium"
                >
                  {t('Start Test')} <ArrowRight className="w-6 h-6" />
                </button>
              </Link>
            ...
            hover:bg-gray-10/20 font-medium"
              >
                {t('More details')} <ArrowDownRight className="w-6 h-6" />
              </button>
            </div>
          </div>
